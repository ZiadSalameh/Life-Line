...
class StoreActivity_methodologiesRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'activity_methodology_name' => 'required',
    ...
    public function messages()
    {
        return [
            ...
            'activity_methodology_name.required' => 'The activity methodology name is required.',
        ];
    }
}

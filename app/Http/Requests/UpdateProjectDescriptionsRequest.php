...
class UpdateProjectDescriptionsRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'project_proposal_name' => 'sometimes',
    ...
    {
        return [
            'project_proposal_id.required' => 'The project proposal ID is required.',
